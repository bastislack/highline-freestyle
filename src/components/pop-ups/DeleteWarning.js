      ...
      <Modal.Body>
        <div className="container">
          <div className="row justify-content-around">
            <button className="col-4 btn btn-secondary" onClick={() => setShowDeleteWarning(false)}>Cancel</button>
            <button className="col-4 btn btn-danger" onClick={() => {call(); setShowDeleteWarning(false);}}>Delete</button>
          </div>
        </div>
      </Modal.Body>
    </Modal>
