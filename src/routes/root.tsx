...
function ErrorBoundary(): JSX.Element {
  ...
  return (
    <div role="alert">
      ...
      <p>If this is an unexpected error, please write an issue on <a href="https://github.com/bastislack/highline-freestyle/issues">Github</a>, containing what you did to produce this error and the following error msg:</p>
...
export default function toRoute() : RouteObject {
  return {
    element: <Root/>,
    path: "/",
