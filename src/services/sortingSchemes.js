...
export const trickSortingSchemes = [
  {"name": <Fragment><Trans id={common.level.id} /> <BsArrowUp className="navigation-icon" /></Fragment>,
    "id": 0,
  ...
  {"name": <Fragment><Trans id={common.level.id} /> <BsArrowDown className="navigation-icon" /></Fragment>,
    "id": 1,
  ...
  {"name": <Fragment><Trans id={common.stickFrequency.id} /> <BsArrowUp className="navigation-icon" /></Fragment>,
    "id": 2,
  ...
  {"name": <Fragment><Trans id={common.stickFrequency.id} /> <BsArrowDown className="navigation-icon" /></Fragment>,
    "id": 3,
...
export const comboSortingSchemes = [
  {"name": <Fragment><Trans id={common.length.id} /> <BsArrowUp className="navigation-icon" /></Fragment>,
    "id": 0,
  ...
  {"name": <Fragment><Trans id={common.length.id} /> <BsArrowDown className="navigation-icon" /></Fragment>,
    "id": 1,
